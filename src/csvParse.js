...
parser
  .on('readable', function () {
    ...
    while ((row = parser.read()) !== null) {
      ...
      const numberOfCorrectAnswers = row.filter((rowItem) => rowItem === 'I').length
      questionItem.numberOfCorrectAnswers = numberOfCorrectAnswers
      questionItem.isMultipleChoice = numberOfCorrectAnswers > 1
